% Script to generate CMD sensitivity estimate
%
% Ted Amdur
% 10/6/20
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
plotRes = 1; %Make plots of resulting CMD pattern and time series
yrSt = 1959;            %Start of interval, inclusive. Must be >=1870
yrEnd = 2019;           %End of interval, inclusive. Must be <= current year
yrCensor = 2;           %1 to remove years coincident with volcanic eruptions
...
cmdMethod = 2;          %1 to employ CMD, 2 to employ LDA
diffwshift = 0;         %1 do employ difference with shift method from Zhou
...
tsiChoice = 1;          %1 Lean (2000) 2 WLS (2005) 3 CMIP6 SOLARIS-HEPPA 4. NRLTSI2
...
lonCov = 6/7; %Percentage of longitudinal data coverage necessary to keep latitude
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ciFlag = 0;             %1 to calculate CI, 0 otherwise
...
elseif TChoice == 4
    [X, Y, Yr,~, var] = ...
    s1a1preparehadcrut('HadCRUT3.nc');
else
...
function [var,Yr,yI] = returnvalidlat(var,Yr,Y,lonCov)
    ...
    obsNum = squeeze(nansum(obsNum > 4,3)); %Keep gridboxes with at least X monthly obs in all years
